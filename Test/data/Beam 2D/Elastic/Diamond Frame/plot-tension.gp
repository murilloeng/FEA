...
plot\
	'Test/data/Beam 2D/Diamond Frame/data-tension.txt' using ($4) : ($1) with lines linestyle 1 title 'u (m) - Numeric',\
	'Test/data/Beam 2D/Diamond Frame/data-tension.txt' using ($4) : ($2) with lines linestyle 2 title 'v (m) - Numeric',\
