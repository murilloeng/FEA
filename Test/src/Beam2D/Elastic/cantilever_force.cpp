...
void test::beam2D::elastic::cantilever_force(void)
{
	...
	model.solve();
	//save
	model.save_results("Test/data/Beam 2D/Elastic/Cantilever Force");
	model.analysis()->solver_static_nonlinear()->save("Test/data/Beam 2D/Elastic/Cantilever Force/data.txt", {
	...
	validator.item(0)->load_numeric("Test/data/Beam 2D/Elastic/Cantilever Force/data.txt", 3, 0);
	validator.item(1)->load_numeric("Test/data/Beam 2D/Elastic/Cantilever Force/data.txt", 3, 1);
	validator.item(2)->load_numeric("Test/data/Beam 2D/Elastic/Cantilever Force/data.txt", 3, 2);
	validator.item(0)->load_reference("Test/data/Beam 2D/Elastic/Cantilever Force/reference.dat", 0, 2);
	validator.item(1)->load_reference("Test/data/Beam 2D/Elastic/Cantilever Force/reference.dat", 0, 1);
	validator.item(2)->load_reference("Test/data/Beam 2D/Elastic/Cantilever Force/reference.dat", 0, 3);
	//validate
	validator.validate();
	//draw
