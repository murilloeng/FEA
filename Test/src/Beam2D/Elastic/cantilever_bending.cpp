...
void test::beam2D::elastic::cantilever_bending(void)
{
	...
	model.solve();
	//save
	model.save_results("Test/data/Beam 2D/Elastic/Cantilever Bending");
	model.analysis()->solver_static_nonlinear()->save("Test/data/Beam 2D/Elastic/Cantilever Bending/data.txt", {
	...
	validator.item(0)->load_numeric("Test/data/Beam 2D/Elastic/Cantilever Bending/data.txt", 3, 0);
	validator.item(1)->load_numeric("Test/data/Beam 2D/Elastic/Cantilever Bending/data.txt", 3, 1);
	validator.item(2)->load_numeric("Test/data/Beam 2D/Elastic/Cantilever Bending/data.txt", 3, 2);
	//validate
	validator.validate();
	//draw
